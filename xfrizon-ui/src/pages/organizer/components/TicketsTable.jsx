      ...
      <table className="w-full text-xs sm:text-sm border-collapse min-w-max">
        ...
        <tbody>
          {safeTickets.map((ticket) => (
            ...
            >
              <td className="py-3 px-3 sm:px-4 text-gray-300 font-mono text-xs whitespace-nowrap">
                {ticket.ticketNumber}
              </td>
              <td className="py-3 px-3 sm:px-4 text-gray-300 font-light whitespace-nowrap">
                {ticket.buyerName}
              </td>
              ...
              <td className="py-3 px-3 sm:px-4">
                <button
                  ...
                  className="px-2.5 py-1.5 border border-zinc-700 hover:border-zinc-600 text-gray-400 hover:text-gray-300 rounded text-xs font-light transition-colors"
                >
                  ⬇
                </button>
              </td>
