...
*Note: If using old database, run these migrations manually or delete tables to regenerate.*
...
7. **Copy webhook secret** (whsec_...) and update in application.properties
